...
function Products() {
  return (
    <div className='min-h-screen w-screen relative'>
      ...
      <a href="/" className="absolute -top-3 left-5 md:left-20 font-custom1 text-2xl md:text-3xl bg-white px-3 py-2 border whitespace-nowrap">
        <div className="text-black transition duration-200 ease-in-out">Back</div>
      </a>
      <div className='min-h-screen w-screen flex justify-center items-center'>
        <div className="font-custom1 grid grid-cols-1 sm:grid-cols-2 gap-4 mb-[7.5%] text-2xl md:text-3xl">
